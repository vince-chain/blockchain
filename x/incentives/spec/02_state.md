...
Say, there are several incentives that have registered an allocation for the $vince coin and the allocation meter for $vince is at 97%. Then a new incentve proposal can only include an $vince allocation at up to 3%, claiming the last remaining allocation capcaity from the $vince rewards in the inflation pool.
