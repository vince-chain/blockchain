...
Here are some production-grade modules that can be used in vince applications, along with their respective documentation:
...
- [erc20](erc20/spec/README.md) - Trustless, on-chain bidirectional internal relaying (*aka* intrarelaying) of tokens between vince' EVM and Cosmos runtimes.
