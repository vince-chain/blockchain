...
import (
	...
	"github.com/AyrisDev/VinceFinance/x/claims"
...
var (
	now     = time.Now().UTC()
	acc1, _ = sdk.AccAddressFromBech32("vince1qxx0fdsmruzuar2fay88lfw6sce6emamyu2s8h4d")
	acc2, _ = sdk.AccAddressFromBech32("vince1nsrs4t7dngkdltehkm3p6n8dp22sz3mct9uhc8")
)
