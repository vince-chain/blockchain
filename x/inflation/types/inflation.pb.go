...
// source: vince/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "vince.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "vince.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("vince/inflation/v1/inflation.proto", fileDescriptor_802efa57c3573b59)
}
