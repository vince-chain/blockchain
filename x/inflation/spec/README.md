...
The `x/inflation` module mints new vince tokens and allocates them in daily
epochs according to the [vince Token
Model](https://vince.blog/the-vince-token-model-edc07014978b) distribution to
...
The allocation of new coins incentivizes specific behaviour in the vince
