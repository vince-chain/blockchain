...
// source: vince/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "vince.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("vince/vesting/v1/vesting.proto", fileDescriptor_64bdc95247c207c8) }
